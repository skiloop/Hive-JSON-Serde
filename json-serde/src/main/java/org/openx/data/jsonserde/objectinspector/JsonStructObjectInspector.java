...
public class JsonStructObjectInspector extends StandardStructObjectInspector {
  ...
  /*  
    ...
    public Object getStructFieldData(Object data, StructField fieldRef) {
        ...
        } else if (data instanceof String && options.parseString()) {
            try {
                return getStructFieldDataFromJsonObject(new JSONObject((String) data), fieldRef);
            } catch (JSONException e) {
                throw new Error("invalid json string: " + data.toString());
            }
        } else {
